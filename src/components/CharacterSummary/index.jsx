...
export default function CharacterSummary ({ character, flexDirection, ...rest }) {
      ...
      >
        <Flex direction={flexDirection ?? ['row', 'row', 'column', 'column', 'column']}>
          ...
          <Box p='2' overflow='hidden'>
            ...
            <Text variant='subTitle' isTruncated>{character.status} - {character.gender} {character.species}</Text>
            <Text isTruncated>
            ...
            <Text as='span' variant='hightLight'>Created: </Text>
